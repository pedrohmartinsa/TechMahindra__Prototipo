    ...
    return (
        <>
            <div className='flex justify-center mt-20 mb-20'>
                <div className='flex flex-col w-96 justify-center items-center gap-y-14 drop-shadow-2xl bg-terciaria p-10 rounded'>

                <div className='flex items-center w-72 gap-x-3 drop-shadow-2xl bg-white p-3 rounded'>
                    <div>
